...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="col-md-8">
            ...
            @endauth
            @guest
            <p>Si deseas comentar <a href="{{ action('Auth\LoginController@showLoginForm') }}">Inicia sesión</a> o 
                <a href="{{ action('Auth\RegisterController@showRegistrationForm') }}">Regístrate</a> </p>
            @endguest
            ...
            @empty
            <p>No hay comentarios para esta publicación, se el primero en comentar.</p>
            @endforelse
        </div>        
    </div>
</div>
